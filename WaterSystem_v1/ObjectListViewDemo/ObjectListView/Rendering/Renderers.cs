...
namespace BrightIdeasSoftware {
    ...
    public class ColumnButtonRenderer : BaseRenderer {
        ...
        protected override void DrawImageAndText(Graphics g, Rectangle r) {
            ...
            Image img = null;
            if (buttonText.ToLower().Equals("update"))
            {
                img = Image.FromFile(@"D:\WaterRepo\Advance-Plan\WaterSystem_v1\WaterSystem_v1\Contents\edit.png");
            }
            else
                img = Image.FromFile(@"D:\WaterRepo\Advance-Plan\WaterSystem_v1\WaterSystem_v1\Contents\Button-Delete.png");

            if (!String.IsNullOrEmpty(buttonText))
                ButtonRenderer.DrawButton(g, r, img, r, false, CalculatePushButtonState());
        }
